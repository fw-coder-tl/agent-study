package com.tianliang.agent.agent;

import com.tianliang.agent.advisor.ReflectionAdvisor;
import com.tianliang.agent.config.ChatModelConfig;
import com.tianliang.agent.tools.SearchService;
import com.tianliang.agent.tools.WeatherService;
...
public class ReflectionAgent {
    ...
    private ReflectionAgent(SimpleReactAgent simpleReactAgent) {
        this.delegate = simpleReactAgent;
    }
